...
<html lang="en">
    <head>
    <title>{{ config('app.name', 'BusfareApp') }}</title><!-- the statement echos the name of the app as the title-->
    
    <meta charset="utf-8"/>
    <meta http-equiv="X-UA-Compatible" content="IE=edge"/>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"/>
    <meta name="description" content=""/>
    <!-- the function "asset" makes the files to be included in all the pages -->
    ...
    <div class="site-nav-section">
        ...
        <div class="menu-wrap"><!--mobile menu-->
	        ...
	        <div class="side-nav-contents">
	        	...
	        	<ul>
	        		...
	        		<li class="signup"><a href="/register">Sign Up</a></li>
                </ul>
        ...
        <div class="site-right-nav">
            <ul class="site-navbar">
                <!-- this route is the link for login-->
